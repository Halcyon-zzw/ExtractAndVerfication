package com.zhuzw.constant;

import java.util.Arrays;
import java.util.List;

public final class ReptileConstant {

    // 定义User-Agent列表
    private static List<String> USER_AGENTS_TEMP_LIST = Arrays.asList(
            ...
            "Mozilla/5.0 (Linux; Android 9; Pixel 2 XL Build/PQ2A.190405.003) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Mobile Safari/537.36",
    ...
    public static List<String> USER_AGENTS_LIST = List.of(
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3",
            ...
            "Mozilla/5.0 (Linux; Android 7.0; SM-G930T Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.125 Mobile Safari/537.36",
     ...
     * 户型
     */
    public static final String LIST_SECOND_HAND_HOUSE = "property-content";
    public static final String HOST_TYPE_SECOND_HAND_HOUSE = "property-content-info-attribute";
    /**
     * 面积
     */
//    public static final String AREA_SECOND_HAND_HOUSE = "property-content-info-text";
    /**
     * 描述
     */
    public static final String DESC_SECOND_HAND_HOUSE = "property-content-info-text";
    /**
     * 地址
     */
    public static final String ADDRESS_SECOND_HAND_HOUSE = "property-content-info-comm-address";
    /**
     * 小区名
     */
    public static final String CELL_NAME_SECOND_HAND_HOUSE = "property-content-info-comm-name";
    /**
     * 总价
     */
    public static final String TOTAL_PRICE_HAND_HOUSE = "property-price-total";
    /**
     * 单价
     */
    public static final String UNIT_PRICE_SECOND_HAND_HOUSE = "property-price-average";


    /**
     * 户型
     */
    public static final String LIST_NEW_HOUSE = "item-mod";
    public static final String HOST_TYPE_NEW_HOUSE = "huxing";
    /**
     * 面积
     */
//    public static final String AREA_SECOND_HAND_HOUSE = "property-content-info-text";
     ...
     * 地址
     */
    public static final String ADDRESS_NEW_HOUSE = "address";
    /**
     * 小区名
     */
    public static final String CELL_NAME_NEW_HOUSE = "lp-name";

    /**
     * 单价
     */
    public static final String UNIT_PRICE_NEW_HOUSE = "price";

    /**
     * ================商铺
     */

    public static final String LIST_SHOPS = "list-item";
    /**
     * 商铺title
     */
    public static final String TITLE_SHOPS = "item-title";
    /**
     * 单价
     */
    public static final String UNIT_PRICE_SHOPS = "price-daily";
    /**
     * 总价
     */
    public static final String TOTAL_PRICE_SHOPS = "price-monthly";
    /**
     * 面积
     */
    public static final String AREA_SHOPS = "area";
    /**
     * 地址
     */
    public static final String ADDRESS_SHOPS = "mr5";

    /**
     * 标签
     */
    public static final String TAG_SHOPS = "item-tag";

    /**
     * 描述
     */
    public static final String DESC_SHOPS = "item-descript";
}
